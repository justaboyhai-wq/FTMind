...
export const GLOBAL_USER_GUIDE_KEY = 'keystone:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'keystone:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'keystone:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'keystone:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'keystone:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'keystone:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'keystone:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'keystone:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'keystone:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'keystone:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'keystone:contextual-guide-agent-create:v1',
