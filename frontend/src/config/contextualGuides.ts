...
export const GLOBAL_USER_GUIDE_KEY = 'fmind:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'fmind:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'fmind:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'fmind:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'fmind:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'fmind:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'fmind:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'fmind:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'fmind:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'fmind:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'fmind:contextual-guide-agent-create:v1',
