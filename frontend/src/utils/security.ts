...
const protectedFileCacheState = (() => {
  ...
  const scope = window as typeof window & {
    __fmindProtectedFileCacheV1__?: ProtectedFileCacheState;
  };
  scope.__fmindProtectedFileCacheV1__ ||= fresh();
  return scope.__fmindProtectedFileCacheV1__;
})();
...
function getProtectedFileRequestHeaders(): Record<string, string> {
  ...
  try {
    ...
    if (selectedTenantId) {
      ...
      // active tenant into fmind_tenant, leaving authenticated file
