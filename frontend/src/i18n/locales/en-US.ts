...
\
  ...
  externalMemory: {
    ...
    overview: {
      title: 'External memory overview', desc: 'Review external-agent access and L3 memory review status.',
      activeBindings: 'Active bindings', activeBindingsHint: 'External-agent bindings that can currently access memory',
      revokedBindings: 'Revoked bindings', revokedBindingsHint: 'External-agent bindings whose access has been stopped',
      pendingReviews: 'Pending memories', pendingReviewsHint: 'L3 memories awaiting review or requested changes',
      publishedReviews: 'Published memories', publishedReviewsHint: 'L3 memories published to the Memory Wiki',
      openBindings: 'Manage bindings', openReviews: 'View reviews', wikiHint: 'Only approved L3 memories can be published to the dedicated Memory Wiki.',
    },
    ...
    fields: {
      department: 'Department', teamId: 'Team ID', userId: 'User ID', agentId: 'FTMind agent ID', externalAgent: 'External agent ID', connector: 'Connector type', capabilities: 'Capabilities', assetScopes: 'Asset scopes', assetScopesHelp: 'One scope per line or comma-separated, e.g. team:engineering.',
      selectDepartment: 'Select a department', selectTeam: 'Select a team', selectAgent: 'Select an agent', selectUser: 'Select a user', selectOrganizationFirst: 'Select a department, team, agent, and user first.', noTeams: 'There are no teams in this department.', organizationLoadFailed: 'Unable to load organization information.',
      userApiKey: 'User API key', userApiKeyHelp: 'Select an existing FTMind API key for the bound user; prompts use environment-variable placeholders only.', selectUserApiKey: 'Select a user API key', unassignedKey: 'No user assigned',
    },
    connectorTypes: { openclaw_plugin: 'OpenClaw plugin', hermes_provider: 'Hermes provider', openai_proxy: 'OpenAI proxy', anthropic_proxy: 'Anthropic proxy', mcp: 'MCP', generic_sdk: 'Generic SDK' },
    capabilities: { memory_context: 'Use memory context', memory_capture: 'Capture memory', memory_recall: 'Recall memory', memory_confirm: 'Confirm memory candidates', memory_publish: 'Publish Memory Wiki', knowledge_search: 'Search knowledge bases', wiki_get: 'Read Wiki pages', document_read: 'Read documents', context_assemble: 'Assemble context' },
    policy: { capture: 'Capture memory', recall: 'Recall memory', l3: 'Enable L3 Memory Wiki publishing' },
    ...
    setupWizard: { title: 'Complete external-agent setup', warning: 'Keep this setup information safe. It cannot be viewed again after this window is closed.', expires: 'Expires at:', instructions: 'Provide the following setup prompt to the external agent to complete the connection.', copyPrompt: 'Copy setup prompt', copied: 'Setup prompt copied' },
    reviews: { title: 'L3 review & publish', desc: 'Only approved L3 memory is eligible for the dedicated zero-RAG Memory Wiki.', allStatuses: 'All statuses', empty: 'No L3 memory reviews.', open: 'Review', detailTitle: 'L3 memory review', markdown: 'Content', evidence: 'Evidence', noEvidence: 'No evidence is recorded.', reviewComment: 'Review comment', comment: 'Comment', commentRequired: 'A comment is required when requesting changes.', commentOptional: 'Optional comment' },
    actions: { approve: 'Approve', reject: 'Reject', requestChanges: 'Request changes', publish: 'Publish to Memory Wiki', saved: 'Review saved', published: 'Published to Memory Wiki' }, columns: { externalAgent: 'External agent', connector: 'Connector', team: 'Team', policy: 'Policy', status: 'Status', actions: 'Actions', title: 'L3 title', agent: 'Agent' }, status: { pending_setup: 'Pending setup', pending_review: 'Pending review', changes_requested: 'Changes requested', approved: 'Approved', publishing: 'Publishing', published: 'Published', rejected: 'Rejected', revoked: 'Revoked', active: 'Active' }, detail: { memoryId: 'Memory ID' }, bindingError: 'The agent-binding request is invalid. Check the fields and try again.', validation: { required: 'This field is required.' }, error: { load: 'Unable to load external memory data.', save: 'Unable to save this change.' },
  },
}
