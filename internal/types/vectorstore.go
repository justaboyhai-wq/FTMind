	...
	return []VectorStoreTypeInfo{
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "index_name", Type: "string", Required: false, Description: "Index Name", Default: "fmind"},
		...
		},
		{
			...
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "fmind_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: false, Description: "Database", Default: "fmind"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_name", Type: "string", Required: false, Description: "Collection Name", Default: "fmind_embeddings"},
		...
		},
		{
			...
			ConnectionFields: []VectorStoreFieldInfo{
				...
				{Name: "database", Type: "string", Required: true, Description: "Database", Default: "fmind"},
				{Name: "username", Type: "string", Required: false, Description: "Username", Default: "root"},
				{Name: "password", Type: "string", Required: false, Sensitive: true, Description: "Password"},
			},
			IndexFields: []VectorStoreFieldInfo{
				{Name: "collection_prefix", Type: "string", Required: false, Description: "Table Prefix", Default: "fmind_embeddings"},
