// Package feishu implements the Feishu (飞书/Lark) data source connector for FTMind.
//
// It syncs documents from Feishu Wiki spaces and cloud documents into FTMind knowledge bases.
//
// Feishu API docs:
