...
import (
	...
	memoryRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/memory/neo4j"
	dorisRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/doris"
	elasticsearchRepoV7 "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/elasticsearch/v7"
	elasticsearchRepoV8 "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/elasticsearch/v8"
	milvusRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/milvus"
	neo4jRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/neo4j"
	openSearchRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/opensearch"
	postgresRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/postgres"
	qdrantRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/qdrant"
	sqliteRetrieverRepo "github.com/justaboyhai-wq/fmind/internal/application/repository/retriever/sqlite"
	...
	feishuConnector "github.com/justaboyhai-wq/fmind/internal/datasource/connector/feishu"
	notionConnector "github.com/justaboyhai-wq/fmind/internal/datasource/connector/notion"
	rssConnector "github.com/justaboyhai-wq/fmind/internal/datasource/connector/rss"
	yuqueConnector "github.com/justaboyhai-wq/fmind/internal/datasource/connector/yuque"
	...
	imPkg "github.com/justaboyhai-wq/fmind/internal/im"
	"github.com/justaboyhai-wq/fmind/internal/im/dingtalk"
	"github.com/justaboyhai-wq/fmind/internal/im/feishu"
	"github.com/justaboyhai-wq/fmind/internal/im/mattermost"
	"github.com/justaboyhai-wq/fmind/internal/im/qqbot"
	"github.com/justaboyhai-wq/fmind/internal/im/slack"
	"github.com/justaboyhai-wq/fmind/internal/im/telegram"
	"github.com/justaboyhai-wq/fmind/internal/im/wechat"
	"github.com/justaboyhai-wq/fmind/internal/im/wecom"
	...
	"github.com/justaboyhai-wq/fmind/internal/router"
	"github.com/justaboyhai-wq/fmind/internal/stream"
...
// (ingestion/enrichment) chat calls when FMIND_MODEL_MAX_CONCURRENCY /
...
func resolveModelMaxConcurrency(ss interfaces.SystemSettingService) int {
	...
	return int(ss.GetInt(context.Background(), "model.max_concurrency",
		"FMIND_MODEL_MAX_CONCURRENCY", int64(defaultModelMaxConcurrency)))
}
