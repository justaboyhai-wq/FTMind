...
This package provides a client library for interacting with Keystone services, supporting all HTTP-based interface calls, making it easier for other modules to integrate with Keystone services without having to write HTTP request code directly.
