...
less or use --format json for large chunks. FTMind chunks are typically bounded
...
const chunkViewExample = `  fmind chunk view chunk_abc
  fmind chunk view chunk_abc --format json | jq '.content'
  fmind chunk view chunk_abc --format json --jq '{id, chunk_index, is_enabled}'`

// NewCmdView builds `fmind chunk view <chunk-id>`.
func NewCmdView(f *cmdutil.Factory) *cobra.Command {
	...
	cmdutil.SetAgentHelp(cmd, cmdutil.AgentHelp{
		...
		Examples:      []string{"fmind chunk view chunk_abc"},
