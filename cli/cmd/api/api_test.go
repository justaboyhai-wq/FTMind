...
// withRootHarness wraps `fmind api ...` under a synthetic root cmd that
...
// escape-hatch DELETE path: agent invokes `fmind api DELETE /...` without
...
// escape-hatch PUT path: `fmind api -X PUT /...` mutates server state the
