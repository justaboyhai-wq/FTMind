...
// confirmation-gated command: head (e.g. []string{"fmind","kb","update",id})
...
// (e.g. []string{"fmind","doc","delete","a","b","-y"}); pass nil when no
...
// retryArgv is the directly-executable retry argv array
// (e.g. []string{"fmind","kb","delete","kb_x","-y"}); pass nil when no
// clean retry argv is available.
